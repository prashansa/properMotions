...
testH5file = tables.open_file('combinedFile99.h5')#99.h5')#%s.h5' %h5fileName)
...
iterator = pool.imap_unordered(combinedStarGalaxyFunctions.pixelTasksCombinedData,packParameterList[0:10000], chunksize=100)
...
#for param in packParameterList:
    ...
    objIDstar, raStar, decStar =res #combinedStarGalaxyFunctions.pixelTasksCombinedData(param)
